...
Fecha: 16/09/2026. Base revisada: `96829cd` (V8.7.1).
...
## Validación manual pendiente antes de fusionar/publicar

No marcar como superada por los tests DOM: no son un navegador ni una PWA instalada.
La descarga de Chromium mediante Playwright falló por timeout; el binario alternativo no pudo arrancar por errores del entorno gráfico. No se obtuvieron capturas válidas.
...
7. Confirmar en la versión desplegada badge, recursos, caché y documentación. Cambiar las etiquetas de estado de publicación solo tras comprobar GitHub Pages.
