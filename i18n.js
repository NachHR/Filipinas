...
const I18N={
  es:{
    ...
    flights:{return:'Vuelos de vuelta',manage:'Gestionar reserva en Etihad',flight:'Vuelo',returnCheckin:'Check-in de vuelos de vuelta',returnCheckinDesc:'Hacer el check-in de los vuelos de vuelta. Disponible desde el 21 de octubre a las 21:55 (48 h antes del primer vuelo).',returnCheckinNote:'Abrir la gestión oficial de la reserva de Etihad para completar el check-in.',returnItinerary:'Vuelos de vuelta a Madrid',returnItineraryDesc:'CGY → MNL 21:55–23:30. Después: MNL → AUH 05:50–10:50 y AUH → MAD 14:05–19:40 el 24 de octubre.',returnItineraryNote:'23/10: Cagayan de Oro → Manila. 24/10: Manila → Abu Dhabi → Madrid.'},
  ...
  en:{
    ...
    flights:{return:'Return flights',manage:'Manage booking on Etihad',flight:'Flight',returnCheckin:'Return flight check-in',returnCheckinDesc:'Complete the return flight check-in. Available from 21 October at 21:55 (48 hours before the first return flight).',returnCheckinNote:'Open Etihad’s official booking management page to complete check-in.',returnItinerary:'Return flights to Madrid',returnItineraryDesc:'CGY → MNL 21:55–23:30. Then: MNL → AUH 05:50–10:50 and AUH → MAD 14:05–19:40 on 24 October.',returnItineraryNote:'23/10: Cagayan de Oro → Manila. 24/10: Manila → Abu Dhabi → Madrid.'},
...
function tr(value){
  ...
  if(typeof value==='string'&&typeof state!=='undefined'&&state.lang==='en'){
...
function applyShellTranslations(){
  ...
  document.getElementById('closeMenu')?.setAttribute('aria-label',t('shell.menuClose'));
  document.getElementById('budgetCloseButton')?.setAttribute('aria-label',t('shell.menuClose'));
  document.getElementById('dayNavigation')?.setAttribute('aria-label',t('shell.dayNav'));
}
