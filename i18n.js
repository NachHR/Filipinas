...
const I18N = {
  es: {
    ...
    field: {
      ...
      p1: "Tres tomas P1",
      p1Help: "Prioridad del día si el plan y las condiciones lo permiten. Duraciones orientativas; dejar margen antes y después de la acción.",
      captured: "tomas registradas",
      clips: "Clips complementarios y sonido",
      today: "Rodaje de hoy",
      preset: "Preset",
      filter: "Filtro:",
    ...
    day: {
      ...
      flexibleStay: "Alojamiento flexible",
      noBooking: "Sin reserva confirmada. Elegir según la ruta, disponibilidad y presupuesto.",
      booking: "Reserva",
  ...
  en: {
    ...
    field: {
      ...
      p1: "Three P1 shots",
      p1Help: "Today’s priorities if plans and conditions allow. Suggested durations; leave room before and after the action.",
      captured: "shots recorded",
      clips: "Complementary clips and sound",
    ...
    day: {
      ...
      flexibleStay: "Flexible accommodation",
      noBooking: "No confirmed booking. Choose based on route, availability and budget.",
      booking: "Booking",
